...
Route::group(['middleware' => ['auth:sanctum', 'verified']], function () {
    Route::get('/dashboarddd',[AdminController::class,'index'])->name('dashboard');
...
Route::get('/json/reklamslideralt', [MobilAppController::class, 'reklamslideralt']);
Route::get('/json/reklamsliderüst', [MobilAppController::class, 'reklamsliderüst']);
Route::get('/json/reklamhaberdetayüst', [MobilAppController::class, 'reklamhaberdetayüst']);
Route::get('/json/reklamhaberdetayalt', [MobilAppController::class, 'reklamhaberdetayalt']);
...
Route::get('/json/kirmiziMikrafon/', [MobilAppController::class, 'kirmiziMikrafon']);
